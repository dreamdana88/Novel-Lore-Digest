...
9. 使用 `prompts/08_输出SillyTavern世界书.md` 生成世界书；使用 `prompts/09_输出SillyTavern角色卡.md` 生成角色卡。
...
10. 使用 `prompts/10_归并角色卡.md` 或运行 `python scripts/merge_character_cards.py`，把单卡汇总到 `outputs/SillyTavern角色卡汇总.md`（主角在前）。
