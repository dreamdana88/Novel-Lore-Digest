...
适用于主角色、NPC 和角色清单的设定正文；判词／Core 允许文学化，但不得改变事实或越过故事基准时点。不限制文风生成，原文台词保持原样。

- **只写有依据的信息**：行为、外貌、经历、关系，以及原文明确或有充分行为依据的心理与性格变化；不加入叙事者评价或擅自推测动机。
- **不作修辞渲染**：不用比喻、夸张、抒情和装饰性修饰，不用“一丝、极度、极致、绝对”等词强化语气；有依据的外貌特征正常保留。
- **不作额外解释**：避免用破折号、括号反复补充说明，避免“不是……而是……”“没有……而是……”等对比句式及“三分……七分……”式拆分描写。
- **简洁不损害事实**：保留必要的主语、时序、原因和结果，不把经历压缩成含糊的词语串。

客观精准不等于冷冰冰：保留有依据的心理、性格变化和人情味，不写成动作流水账或标签堆砌。
